...
3. Create HTML elements for each quiz question, including the name of the quiz, each question, and all answers for each question, 
(each of which should have a radio button to se
  lect).
...
7. Let's add JavaScript functionality to the "Next" button, to advance which question is shown on the screen 
(big hint: try adding a numerical index to each question, and then an "activeQuestion" javascript variable)

8. Once you have the "Next" button showing just one question at a time, add JavaScript to update the question index text 
(ex, Question 1 out of 4, see design)
 ...
 9. Once we get to the end of the questions, let's display the user's score on the page (how many questions they got right!
...
BONUS CHALLENGES 
- Can you prevent the user from advancing until they have selected a radio option? 
- Can you display an error message if they try, to tell them what to do?
- Can you add a Back button, beside the Next button, that goes to the previous question? 
